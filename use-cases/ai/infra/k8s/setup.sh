...
export ORCHESTRATOR_IMAGE="${ORCHESTRATOR_IMAGE:-orchestrator:latest}"
export AGENT_DB_IMAGE="${AGENT_DB_IMAGE:-agent-db:latest}"
export AGENT_SSH_IMAGE="${AGENT_SSH_IMAGE:-agent-ssh:latest}"
